...
Attributes:
    board (list): A list of lists representing our chessboard.
    solutions (list): A list of lists containing solutions.

Solution(s) are represented in the format [[r, c], [r, c], [r, c], [r, c]]
where `r` and `c` represent the row and column, respectively, where a
queen would be placed on the chessboard.
"""
import sys
...
def board_deepcopy(board):
    """Returning a deepcopy of our chessboard."""
...
def recursive_solve(board, row, queens, solutions):
    ...
    Args:
        ...
        solutions (list): A list of lists of our solutions.
    Returns:
        solutions
    """
    if queens == len(board):
